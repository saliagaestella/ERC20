...
contract ESTATE is ERC20, Ownable {
    ...
    uint256 public swapTokensAtAmount = 10 * 10**8 * (10**11);

    uint16 private totalBuyFee;
    uint16 private totalSellFee;

    address public _teamWalletAddress = address(0x652501F3aeaE5DcbCBD77c92F1F39062278bc56a); // Team Wallet
    address public _projectWalletAddress = address(0x82b4bE68FE593ad1062996370E8Da7e85b83a697); //Project Wallet
    ...
    constructor() ERC20("ESTATE", "ESTATE") {
        ...
        buyFee.projectFee = 50; // 5% Project fee
        buyFee.teamFee = 20;  // 2% team fee
        totalBuyFee = buyFee.projectFee + buyFee.teamFee;

        sellFee.projectFee = 50; // 5% project fee
        sellFee.teamFee = 20;   // 2% team fee
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "ESTATE: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "ESTATE: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "ESTATE: Automated market maker pair is already set to that value");
